      ...
      <div className="space-y-3">
        ...
        >
          <div className="text-left">
            ...
            <div className="text-sm text-muted-foreground">Browse specialists and book appointments</div>
          </div>
        </Button>
        ...
        >
          <div className="text-left">
            ...
            <div className="text-sm text-muted-foreground">View and manage your bookings</div>
          </div>
        </Button>
        ...
        >
          <div className="text-left">
            ...
            <div className="text-sm text-muted-foreground">Get help finding the right specialist</div>
          </div>
        </Button>
      </div>
